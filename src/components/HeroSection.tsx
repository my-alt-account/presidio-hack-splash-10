      ...
      <div className="container mx-auto relative z-10">
        <div className="flex flex-col items-center justify-between gap-8">
          ...
          <div className="flex flex-col items-center text-center w-full max-w-4xl mx-auto">
            {/* Image now appears at the top with reduced top margin */}
            <div className="w-full max-w-xl mb-8 mt-8">  {/* Reduced max-w to xl and mt to 8 */}
              <div className="relative rounded-xl overflow-hidden shadow-xl">  {/* Slightly reduced shadow */}
                <img 
